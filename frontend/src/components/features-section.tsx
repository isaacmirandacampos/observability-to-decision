...
function FeaturesSection() {
  return (
    <section id="features" className="relative bg-white py-20 mt-20 ">
        ...
        <div className="mt-10 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6">
          <div className="relative">
            <div className="text-center">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">
                Discover your price per hour service provision
              </h3>
              <p className="mt-2 text-base text-gray-500">
                The tool helps you to found your minimum and ideal price per
                hour for your.
              </p>
            </div>
          </div>
          <div className="relative">
            <div className="text-center">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">
                Discover the price for project
              </h3>
              <p className="mt-2 text-base text-gray-500">
                A powerful feature to discover the price for the project.
                Suggest the price considering the project complexity, price for
                discount and fees.
              </p>
            </div>
          </div>
          <div className="relative">
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">
                Small entrepreneurs also deserve a vacation, and we help them
                with that.
              </p>
            </div>
          </div>
